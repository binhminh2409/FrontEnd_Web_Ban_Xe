...
@Component({
  selector: 'app-fixed-gear-bicycle',
  templateUrl: './fixed-gear-bicycle.component.html',
  styleUrls: ['./fixed-gear-bicycle.component.scss']
})
export class FixedGearBicycleComponent {
