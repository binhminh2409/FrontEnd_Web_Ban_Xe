...
@Component({
  selector: 'app-wirewrap-handle',
  templateUrl: './wirewrap-handle.component.html',
  styleUrls: ['./wirewrap-handle.component.scss']
})
export class WirewrapHandleComponent {
