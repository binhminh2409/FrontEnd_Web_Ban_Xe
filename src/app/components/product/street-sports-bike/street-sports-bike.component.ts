...
@Component({
  selector: 'app-street-sports-bike',
  templateUrl: './street-sports-bike.component.html',
  styleUrls: ['./street-sports-bike.component.scss']
})
export class StreetSportsBikeComponent {
  ...
  productType = "Xe đạp thể thao đường phố"
