...
@Component({
  selector: 'app-mountain-bike',
  templateUrl: './mountain-bike.component.html',
  styleUrls: ['./mountain-bike.component.scss']
})
export class MountainBikeComponent {
