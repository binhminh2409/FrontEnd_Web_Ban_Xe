...
@Component({
  selector: 'app-folding-bike',
  templateUrl: './folding-bike.component.html',
  styleUrls: ['./folding-bike.component.scss']
})
export class FoldingBikeComponent {
